...
<div class="top-action-bar">
  ...
  <div class="action-icons">
    <a href="auction.php" class="live-auction-bubble hidden-inline" id="liveAuctionBubble" aria-label="Go to live auction" title="Live Auction">
    ...
    <button class="icon-btn" onclick="openAuctions()" aria-label="Auctions" title="Auctions">
    ...
    <button class="icon-btn" onclick="openMessages()" aria-label="Messages" title="Messages">
    ...
    <button id="topCartBtn" class="icon-btn" onclick="openCartPage()" aria-label="Cart" title="Cart">
    ...
    <button class="icon-btn menu-btn" onclick="toggleMenuDropdown()" aria-label="Menu" title="Menu">
